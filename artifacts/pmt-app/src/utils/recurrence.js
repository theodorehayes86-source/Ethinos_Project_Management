/**
 * Shared recurrence utilities — used by every task creation surface
 * (HomeView, ClientView, TeamView). Import from here; do NOT duplicate
 * implementations in component files.
 *
 * Identical logic lives in artifacts/pmt-mobile/src/utils/recurrence.js —
 * keep both in sync.
 */
 ...
 *
 * Caller is responsible for surfacing errors when an empty array is
 * unexpected (e.g. for a repeating task the form should abort, not fall
 * back to a single occurrence).
 *
