...
export function getUserTaskStats(userId, clientLogs, clients) {
  ...
  return { total: tasks.length, today: todayTasks.length, overdue: overdueTasks.length, pendingQC: pendingQC.length, avgRating, allTasks: tasks, todayTasks, overdueTasks };
}
